...
if &t_Co >= 256 || has("gui_running")
		hi Normal ctermbg=0 ctermfg=7 cterm=NONE guibg=#3e5059 guifg=#f0f0f0 gui=NONE
	set background=dark
		...
		hi StatusLine ctermbg=7 ctermfg=0 cterm=NONE guibg=#f0f0f0 guifg=#3e5059 gui=NONE
		...
		hi PmenuSbar ctermbg=6 ctermfg=7 cterm=NONE guibg=#b8ccc9 guifg=#f0f0f0 gui=NONE
