...
if &t_Co >= 256 || has("gui_running")
		hi Normal ctermbg=0 ctermfg=7 cterm=NONE guibg=#434e4a guifg=#f0e4dc gui=NONE
	set background=dark
		...
		hi Error ctermbg=1 ctermfg=7 cterm=NONE guibg=#99736e guifg=#f0e4dc gui=NONE
		...
		hi helpLeadBlank ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0e4dc gui=NONE
		hi helpNormal ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0e4dc gui=NONE
		...
		hi Pmenu ctermbg=8 ctermfg=7 cterm=NONE guibg=#70838c guifg=#f0e4dc gui=NONE
		hi PmenuSbar ctermbg=6 ctermfg=7 cterm=NONE guibg=#8fb3ad guifg=#f0e4dc gui=NONE
		...
		hi FoldColumn ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0e4dc gui=NONE
		...
		hi Search ctermbg=3 ctermfg=0 cterm=NONE guibg=#bfb7a1 guifg=#434e4a gui=NONE
		...
		hi CursorColumn ctermbg=8 ctermfg=7 cterm=NONE guibg=#70838c guifg=#f0e4dc gui=NONE
		hi ModeMsg ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0e4dc gui=NONE
		...
		hi Operator ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0e4dc gui=NONE
		...
		hi vimBracket ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0e4dc gui=NONE
		...
		hi htmlEndTag ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0e4dc gui=NONE
		hi htmlTag ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0e4dc gui=NONE
		hi htmlTagName ctermbg=NONE ctermfg=1 cterm=BOLD guibg=NONE guifg=#99736e gui=BOLD
		hi htmlH1 ctermbg=NONE ctermfg=7 cterm=BOLD guibg=NONE guifg=#f0e4dc gui=BOLD
		...
		hi cssBraces ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0e4dc gui=NONE
			hi link cssAttrComma cssBraces
		hi cssValueLength ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0e4dc gui=NONE
		hi cssUnitDecorators ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0e4dc gui=NONE
		hi cssValueNumber ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0e4dc gui=NONE
		...
		hi scssSelectorChar ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0e4dc gui=NONE
		hi scssAttribute ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0e4dc gui=NONE
		...
		hi javaScript ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0e4dc gui=NONE
		hi javaScriptBraces ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0e4dc gui=NONE
		...
		hi markdownError ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0e4dc gui=NONE
		...
		hi xdefaultsValue ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0e4dc gui=NONE
		...
		hi rubyRegexpAnchor ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0e4dc gui=NONE
		...
		hi phpMemberSelector ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0e4dc gui=NONE
		hi phpComparison ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0e4dc gui=NONE
		hi phpParent ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0e4dc gui=NONE
		...
		hi NERDTreeExecFile ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0e4dc gui=NONE
...
let g:terminal_color_15 = "#f0e4dc"
