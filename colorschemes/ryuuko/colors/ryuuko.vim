...
if &t_Co >= 256 || has("gui_running")
		hi Normal ctermbg=0 ctermfg=7 cterm=NONE guibg=#475359 guifg=#f0eae6 gui=NONE
	set background=dark
		hi NonText ctermbg=NONE ctermfg=0 cterm=NONE guibg=NONE guifg=#475359 gui=NONE
		...
		hi Error ctermbg=1 ctermfg=7 cterm=NONE guibg=#99736e guifg=#f0eae6 gui=NONE
		hi Identifier ctermbg=NONE ctermfg=1 cterm=NONE guibg=NONE guifg=#99736e gui=NONE
		hi Ignore ctermbg=8 ctermfg=0 cterm=NONE guibg=#70838c guifg=#475359 gui=NONE
		hi PreProc ctermbg=NONE ctermfg=3 cterm=NONE guibg=NONE guifg=#bfb7a1 gui=NONE
		hi Special ctermbg=NONE ctermfg=6 cterm=NONE guibg=NONE guifg=#b8ccc9 gui=NONE
		...
		hi StatusLine ctermbg=0 ctermfg=8 cterm=NONE guibg=#475359 guifg=#70838c gui=NONE
		...
		hi TabLineSel ctermbg=4 ctermfg=0 cterm=NONE guibg=#7c9fa6 guifg=#475359 gui=NONE
		hi TermCursorNC ctermbg=3 ctermfg=0 cterm=NONE guibg=#bfb7a1 guifg=#475359 gui=NONE
		...
		hi helpLeadBlank ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0eae6 gui=NONE
		hi helpNormal ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0eae6 gui=NONE
		hi Visual ctermbg=8 ctermfg=0 cterm=NONE guibg=#70838c guifg=#475359 gui=NONE
		hi VisualNOS ctermbg=NONE ctermfg=1 cterm=NONE guibg=NONE guifg=#99736e gui=NONE
		hi Pmenu ctermbg=8 ctermfg=7 cterm=NONE guibg=#70838c guifg=#f0eae6 gui=NONE
		hi PmenuSbar ctermbg=6 ctermfg=7 cterm=NONE guibg=#b8ccc9 guifg=#f0eae6 gui=NONE
		hi PmenuSel ctermbg=4 ctermfg=0 cterm=NONE guibg=#7c9fa6 guifg=#475359 gui=NONE
		hi PmenuThumb ctermbg=8 ctermfg=8 cterm=NONE guibg=#70838c guifg=#70838c gui=NONE
		hi FoldColumn ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0eae6 gui=NONE
		hi Folded ctermbg=NONE ctermfg=8 cterm=NONE guibg=NONE guifg=#70838c gui=NONE
		hi WildMenu ctermbg=2 ctermfg=0 cterm=NONE guibg=#78a090 guifg=#475359 gui=NONE
		...
		hi IncSearch ctermbg=3 ctermfg=0 cterm=NONE guibg=#bfb7a1 guifg=#475359 gui=NONE
		hi Search ctermbg=3 ctermfg=0 cterm=NONE guibg=#bfb7a1 guifg=#475359 gui=NONE
		hi Directory ctermbg=NONE ctermfg=4 cterm=NONE guibg=NONE guifg=#7c9fa6 gui=NONE
		hi MatchParen ctermbg=8 ctermfg=0 cterm=NONE guibg=#70838c guifg=#475359 gui=NONE
		...
		hi WarningMsg ctermbg=1 ctermfg=0 cterm=NONE guibg=#99736e guifg=#475359 gui=NONE
		...
		hi CursorColumn ctermbg=8 ctermfg=7 cterm=NONE guibg=#70838c guifg=#f0eae6 gui=NONE
		hi ModeMsg ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0eae6 gui=NONE
		...
		hi SpellRare ctermbg=NONE ctermfg=6 cterm=underline guibg=NONE guifg=#b8ccc9 gui=underline guisp=#b8ccc9
		...
		hi Operator ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0eae6 gui=NONE
		...
		hi vimBracket ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0eae6 gui=NONE
		...
		hi htmlEndTag ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0eae6 gui=NONE
		hi htmlTag ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0eae6 gui=NONE
		hi htmlTagName ctermbg=NONE ctermfg=1 cterm=BOLD guibg=NONE guifg=#99736e gui=BOLD
		hi htmlH1 ctermbg=NONE ctermfg=7 cterm=BOLD guibg=NONE guifg=#f0eae6 gui=BOLD
		...
		hi cssBraces ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0eae6 gui=NONE
			hi link cssAttrComma cssBraces
		hi cssValueLength ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0eae6 gui=NONE
		hi cssUnitDecorators ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0eae6 gui=NONE
		hi cssValueNumber ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0eae6 gui=NONE
		...
		hi scssSelectorChar ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0eae6 gui=NONE
		hi scssAttribute ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0eae6 gui=NONE
		...
		hi javaScript ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0eae6 gui=NONE
		hi javaScriptBraces ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0eae6 gui=NONE
		...
		hi markdownError ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0eae6 gui=NONE
		...
		hi xdefaultsValue ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0eae6 gui=NONE
		...
		hi rubyRegexp ctermbg=NONE ctermfg=6 cterm=NONE guibg=NONE guifg=#b8ccc9 gui=NONE
		...
		hi rubyRegexpAnchor ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0eae6 gui=NONE
		...
		hi phpMemberSelector ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0eae6 gui=NONE
		hi phpComparison ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0eae6 gui=NONE
		hi phpParent ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0eae6 gui=NONE
		hi cOperator ctermbg=NONE ctermfg=6 cterm=NONE guibg=NONE guifg=#b8ccc9 gui=NONE
		...
		hi NERDTreeExecFile ctermbg=NONE ctermfg=7 cterm=NONE guibg=NONE guifg=#f0eae6 gui=NONE
...
" }}}
	...
	let g:terminal_color_6 = "#b8ccc9"
	let g:terminal_color_7 = "#f0eae6"
	...
	let g:terminal_color_14 = "#b8ccc9"
	let g:terminal_color_15 = "#f0eae6"
