...
if &t_Co >= 256 || has("gui_running")
		hi Normal ctermbg=0 ctermfg=7 cterm=NONE guibg=#3e5059 guifg=#f0eae6 gui=NONE
	set background=dark
		hi NonText ctermbg=NONE ctermfg=0 cterm=NONE guibg=NONE guifg=#3e5059 gui=NONE
		...
		hi Ignore ctermbg=8 ctermfg=0 cterm=NONE guibg=#70838c guifg=#3e5059 gui=NONE
		...
		hi StatusLine ctermbg=0 ctermfg=8 cterm=NONE guibg=#3e5059 guifg=#70838c gui=NONE
		...
		hi TabLineSel ctermbg=4 ctermfg=0 cterm=NONE guibg=#7c9fa6 guifg=#3e5059 gui=NONE
		hi TermCursorNC ctermbg=3 ctermfg=0 cterm=NONE guibg=#bfb7a1 guifg=#3e5059 gui=NONE
		...
		hi Visual ctermbg=8 ctermfg=0 cterm=NONE guibg=#70838c guifg=#3e5059 gui=NONE
		...
		hi PmenuSel ctermbg=4 ctermfg=0 cterm=NONE guibg=#7c9fa6 guifg=#3e5059 gui=NONE
		...
		hi WildMenu ctermbg=2 ctermfg=0 cterm=NONE guibg=#78a090 guifg=#3e5059 gui=NONE
		...
		hi IncSearch ctermbg=3 ctermfg=0 cterm=NONE guibg=#bfb7a1 guifg=#3e5059 gui=NONE
		...
		hi WarningMsg ctermbg=1 ctermfg=0 cterm=NONE guibg=#99736e guifg=#3e5059 gui=NONE
