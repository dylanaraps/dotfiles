...
if &t_Co >= 256 || has("gui_running")
		hi Normal ctermbg=0 ctermfg=7 cterm=NONE guibg=#434e4a guifg=#f0eae6 gui=NONE
	set background=dark
		...
		hi PmenuSbar ctermbg=6 ctermfg=7 cterm=NONE guibg=#8fb3ad guifg=#f0eae6 gui=NONE
