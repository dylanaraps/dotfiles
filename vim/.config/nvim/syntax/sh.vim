...
" Last Change:		Jan 11, 2019
" Version:		186	ASTRO-ONLY
...
syn cluster shEchoList	contains=shArithmetic,shCommandSub,shCommandSubBQ,shDeref,shDerefSimple,shEchoEscape,shExSingleQuote,shExDoubleQuote,shSingleQuote,shDoubleQuote,shCtrlSeq,shEchoQuote
...
"see sh11 for reason for shEchoEscape
syn match   shEscape	contained	'\%(^\)\@!\%(\\\\\)*\\.'
syn match   shEchoEscape	contained	'\%(^\)\@!\%(\\\\\)*\\.'	nextgroup=shComment
...
if !exists("skip_sh_syntax_inits")
 ...
 hi def link shEchoEscape	shEscape
